      ...
      <div className="flex flex-wrap -m-4">
        ...
        <Link passHref={true} href={`/product/${products[P].slug}`}>
          <div className="block relative h-48 rounded overflow-hidden">
            <img alt="ecommerce" className="md:h-[36vh] md:w-[40vh] block h-[30vh] m-auto  " src={products[P].image}/>
          </div>
          <div className="mt-4 text-center">
            <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">hoodiess</h3>
...
export async function getServerSideProps(context) {
  ...
  return {
    props: {products:JSON.parse(JSON.stringify(hoodiess))}, // will be passed to the page component as props
  }
}
